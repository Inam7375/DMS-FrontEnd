        ...
        <div class="vx-row no-gutter justify-center items-center">
          ...
          <div class="vx-col sm:w-full md:w-full lg:w-1/2 d-theme-dark-bg">
            <div class="p-8 login-tabs-container">
               <b-alert v-if="message && message.length > 0" class="alert" show dismissible fade:variant="messageVariant" >{{message}}</b-alert>
              
              <div class="vx-card__title mb-6">
                <!-- <h4 class="mb-4  mr-4 justify-center items-center">Login</h4> -->
                <p>Welcome, Please Sign In To FUUAST DMS.</p>
              </div>
