            ...
            <vs-tabs>
                <vs-tab label="Profile">
                    <div class="con-tab-ejemplo">
                        ...
                        <vs-button @click="updateUser" color="primary" type="flat">Update</vs-button>
                    </div>
                </vs-tab>
...
export default {
    ...
    methods: {
        updateUser : async function(e){
            ...
            const response = await axios.put(`http://localhost:5000/api/user/${this.$route.params.username}`, updateUser)
            console.log(response.data.msg)
        }
    },
    async created() {
        const res = await axios.get(`http://localhost:5000/api/user/${this.$route.params.username}`)
        const user = res.data
